...
⭔ Detail: ${detail}`
            ...
            case 'list': case 'menu': case 'help': case '?': {
                anu = `ʜᴀʟʟᴏ ᴋᴀᴋ *${pushname}*! 
ʙᴏᴛ ɪɴɪ ᴀᴅᴀʟᴀʜ ʙᴇᴛᴀ ᴍᴜʟᴛɪ-ᴅᴇᴠɪᴄᴇ ᴡʜᴀᴛꜱᴀᴘᴘ,ꜱᴀʏᴀ ᴅɪᴄɪᴘᴛᴀᴋᴀɴ ᴏʟᴇʜ ᴀʀᴜʟʟ,ᴅɪᴀ ɢᴀɴᴛᴇɴɢ ʟᴏʜ🗿

❏ *Info Creator*
> ɴᴀᴍᴇ : *ᴀʀᴜʟʟᴏꜰᴄ*
> ɴᴏᴍᴏʀ : *https://wa.me/6285822347348*
> ᴜᴍᴜʀ : *18*
> ʀᴇɢɪᴏɴ : *ɪɴᴅᴏɴᴇꜱɪᴀ 🇲🇨*
> ʜᴏʙʙʏ : *ɢᴛᴡ*
> ᴍᴀᴅᴇ ɪɴ : *ᴋᴀʟɪᴍᴀɴᴛᴀɴ ꜱᴇʟᴀᴛᴀɴ*
> ɴᴀᴍᴀ ᴀꜱʟɪ : *ꜱᴀʜʀᴜʟʟ... ᴘʀɪᴠᴀᴛᴇ*
└───────⭓
*ꜱɪʟᴀʜᴋᴀɴ ʟɪʜᴀᴛ ᴍᴇɴᴜ ᴅɪʙᴀᴡᴀʜ*
┌──⭓ *Group Menu*
│
│⭔ ${prefix}linkgroup
